...
const descriptionStyles: Record<string, string> = {
  ...
  "Etched Foil": "bg-foil/15 text-foil border-foil/30",
};
...
const FOIL_TYPES = [
  ...
  { value: "Etched Foil", label: "Etched Foil" },
];
...
const InventoryTable = ({ data }: Props) => {
  ...
  const typeFilters = ["all", "Foil", "Non-Foil", "Surge Foil", "Rainbow Foil", "Holo Foil", "Galaxy Foil", "Confetti Foil", "Etched Foil"];
        ...
        <div className="flex flex-col gap-3 p-3 sm:p-4 border-b border-border">
          ...
          {availableSets.length > 0 && (
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <SetCombobox sets={availableSets} value={filterSet} onChange={setFilterSet} />
              {filterSet !== "all" && (
