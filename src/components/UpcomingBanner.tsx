import festivalBanner from "@/assets/banner-festival-box-vegas.jpeg";
  ...
  return (
    <div className="space-y-4">
      {banners.map((banner, i) => (
        <div key={i} className="glass-card overflow-hidden glow-hover group relative rounded-2xl">
          <div className="relative">
            <div className="w-full aspect-[16/7] sm:aspect-[16/6] overflow-hidden">
              <img
                src={banner.image}
                alt={banner.title}
