...
<div className="min-h-screen bg-background flex flex-col relative overflow-hidden">
  ...
  <div className="absolute inset-0 bg-gradient-to-b from-black/40 via-black/50 to-background/90 pointer-events-none" />

  <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-primary/5 blur-[120px] pointer-events-none" />

  <div className="relative z-30 flex justify-end p-4 sm:p-6 animate-fade-in pointer-events-auto">
    <Button
      type="button"
  ...
  <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 -mt-16">
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 -mt-16">
        ...
        <p
          className="text-foreground/60 text-center text-sm sm:text-base font-body mb-8 max-w-md tracking-wider uppercase animate-fade-in"
